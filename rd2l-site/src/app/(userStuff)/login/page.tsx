...
export default function Login() {
    ...
    const onClick = (provider: "google" | "reddit" | "steam") => {
        signIn(provider, {
            ...
            <div className="flex flex-col w-80 h-96 justify-evenly items-center text-black rounded-[4px] p-3 drop-shadow-[0_0_6rem_#ffffff70] border-3 border-black">
                ...
                <div className="min-w-full">
                    <ul className="flex gap-1 min-w-fit">
                        <button onClick={() => onClick("steam")} className="flex justify-around border-gray-100 hover:bg-gray-100 border-2 shadow-sm w-full h-9 rounded-[4px]">
                            <p>?</p>
                        </button>
