...
export default function Login() {
    return (
        <main className="flex min-h-screen flex-col items-center justify-center p-10">
            <form className="flex flex-col gap-3 w-72 justify-around items-center bg-white text-black rounded-md p-6 drop-shadow-[0_0_6rem_#ffffff70] border-3 border-black">
                ...
                <button type="submit" className="text-white bg-black rounded-md p-1 w-20 hover:bg-[#1c1c1c]">Sign In</button>
