...
export default function Registration() {
    return (
        <main className="flex min-h-screen flex-col items-center justify-center p-10">
            <form className="flex flex-col gap-1 w-72 h-96 justify-around items-center bg-white text-black rounded-md p-6 drop-shadow-[0_0_6rem_#ffffff70] border-3 border-black">
                <h1 className="uppercase font-mono font-extrabold text-2xl">Sign Up</h1>
                <input placeholder="username" className="border-black border-2 p-1 rounded-md"></input>
                <input placeholder="password" className="border-black border-2 p-1 rounded-md"></input>
                <button type="submit" className="text-white bg-black rounded-md p-1 min-w-full hover:bg-[#1c1c1c]">Sign Up</button>
                <div className="flex flex-col gap-[2px]">
                    <p className="text-center">or</p>
                    <ul className="flex justify-center items-center gap-2">
                        <Link href="/api/auth/signin/google">
                            <li className="flex justify-around border-gray-100 hover:bg-gray-100 border-2 shadow-sm w-32 h-9 rounded-md">
                        ...
                        <li className="flex justify-center items-center border-gray-100 hover:bg-gray-100 border-2 shadow-sm w-32 h-9 rounded-md">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48">
