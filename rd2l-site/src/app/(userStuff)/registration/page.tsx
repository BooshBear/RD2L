...
export default function Registration() {
    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-center p-10">
            <div className="flex flex-col w-80 h-96 justify-evenly items-center bg-white text-black rounded-md p-3 drop-shadow-[0_0_6rem_#ffffff70] border-3 border-black">
                <form className="flex flex-col gap-2 justify-center items-center min-w-full">
                    ...
                    <input placeholder="username" className="border-black border-2 p-1 rounded-md w-60"></input>
                    <input placeholder="password" className="border-black border-2 p-1 rounded-md w-60"></input>
                    <button type="submit" className="text-white bg-black rounded-md p-1 min-w-full hover:bg-[#1c1c1c]">Login</button>
                </form>
                <p className="text-center">or</p>
                <div className="min-w-full">
                    <ul className="flex gap-1 min-w-fit">
                        <button onClick={() => onClick("google")} className="flex justify-around border-gray-100 hover:bg-gray-100 border-2 shadow-sm w-full h-9 rounded-md">
                        ...
                        <button onClick={() => onClick("reddit")} className="flex justify-around border-gray-100 hover:bg-gray-100 border-2 shadow-sm w-full h-9 rounded-md">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="30" height="30" viewBox="0 0 48 48">
                ...
                <div className="flex flex-col justify-center items-center">  
                    <Link href={"/login"} className='text-blue-400 hover:text-blue-500'>Have an account?</Link>
                </div>
            </div>
        </main>
    )
