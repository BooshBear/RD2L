    ...
    return (
        <footer className='bg-zinc-400 p-2 grid grid-cols-3 text-center text-[#0c0c0c] font-mono'>
            ...
            <div className="flex flex-col">
              ...
              {/* <Link href={"/"} target="_blank" className='text-blue-600 hover:text-blue-800'></Link> */}
            </div>
            <div className='col-span-3 flex justify-center items-center gap-5'>
                {/* Link to my github */}
                <Link href={"https://github.com/BooshBear/RD2L"} target="_blank">
                    <svg className="w-8 h-8 m-1 fill-blue-600 hover:fill-blue-800" aria-hidden="true" data-prefix="fab" data-icon="github" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" data-fa-i2svg="">
                ...
                <Link href={"https://discord.com/invite/y4NkFrw"} target="_blank">
                    <svg className="w-8 h-8 m-1 fill-blue-600 hover:fill-blue-800" aria-hidden="true" data-prefix="fab" data-icon="discord" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg="">
