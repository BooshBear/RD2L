    ...
    return (
        <footer className='bg-neutral-800 p-2 grid grid-cols-3 text-white font-mono'>
            <div className="flex flex-col items-center">
              ...
              <Link href={"https://github.com/Dmailloux03/RD2L/issues/new"} target="_blank" className='text-blue-400 hover:text-blue-500'>Report a bug</Link>
            ...
            <div className="flex flex-col items-center">
              ...
              <Link href={"https://github.com/Dmailloux03/RD2L"} target="_blank" className='text-blue-400 hover:text-blue-500'>Github</Link>
            ...
            <div className='col-span-3 flex justify-center items-center gap-5'>
                {/* Link to my github */}
                <Link href={"https://github.com/Dmailloux03/RD2L"} target="_blank">
